...
public sealed class ProductLocalizer
{
    ...
    private static FrozenDictionary<string, string> CreateEnglish() =>
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["SettingsSubtitle"] = "Change appearance, behavior, startup, and update options.",
            ...
            ["TaskbarPlacement"] = "Taskbar placement",
            ["SelectTaskbarPlacement"] = "Choose where the control bar appears",
            ["TaskbarPlacementAutomation"] = "Taskbar control bar placement",
            ["Theme"] = "Theme",
            ...
            ["CheckForUpdatesAtStartupName"] = "Automatically check for QuickPods updates",
            ["CheckForUpdatesAtStartup"] = "Check for updates when QuickPods starts",
            ["SupportSection"] = "Support",
            ["OpenLogsName"] = "Open the QuickPods log folder",
            ["OpenLogs"] = "Open logs",
            ["CopyDiagnosticsName"] = "Copy QuickPods diagnostics to the clipboard",
            ["CopyDiagnostics"] = "Copy diagnostics",
            ["CheckForUpdatesName"] = "Check for QuickPods updates now",
            ["CheckForUpdates"] = "Check for updates",
            ["OpenLatestReleaseName"] = "Open the latest QuickPods release page",
            ["OpenLatestRelease"] = "Open release page",
            ["UpdateNotChecked"] = "Updates have not been checked in this session.",
            ["CheckingForUpdates"] = "Checking the latest QuickPods release…",
            ["UpdateUpToDateStatus"] = "No newer release was found (latest published: v{0}). Last checked: {1}",
            ["UpdateAvailableStatus"] = "QuickPods v{0} is available. Last checked: {1}",
            ["UpdateCheckFailedStatus"] = "The update check failed: {0}",
            ...
            ["ChoiceNotificationAreaLeftDefault"] = "Left of notification area (default)",
            ["ChoiceTaskbarLeft"] = "Left side of taskbar",
            ...
            ["ReleasePageOpenFailed"] = "The QuickPods release page could not be opened: {0}",
            ...
            ["TrayRefresh"] = "Refresh device status",
            ...
            ["TrayExit"] = "Exit",
            ["UpdateNotificationTitle"] = "QuickPods update",
            ["UpdateAvailableNotification"] = "QuickPods v{0} is available. Click to open the official release page.",
            ["UpToDateNotification"] = "QuickPods v{0} is the latest version.",
            ["UpdateCheckFailedNotification"] = "The latest release could not be checked. Try again from QuickPods Settings.",
    ...
    private static FrozenDictionary<string, string> CreateJapanese() =>
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["SettingsSubtitle"] = "表示、操作、起動方法、アップデートを変更します。",
            ["AutoSaveNotice"] = "変更は自動的に保存されます",
            ["DisplaySection"] = "表示",
            ["TaskbarDisplay"] = "タスクバー表示",
            ["SelectDisplayMethod"] = "表示方法を選択",
            ["TaskbarDisplayAutomation"] = "タスクバー表示モード",
            ["TaskbarPlacement"] = "タスクバー内の配置",
            ["SelectTaskbarPlacement"] = "操作バーの表示位置を選択",
            ["TaskbarPlacementAutomation"] = "タスクバー操作バーの配置位置",
            ["Theme"] = "テーマ",
            ...
            ["CheckForUpdatesAtStartupName"] = "QuickPodsのアップデートを自動確認",
            ["CheckForUpdatesAtStartup"] = "QuickPods起動時にアップデートを確認",
            ["SupportSection"] = "サポート",
            ["OpenLogsName"] = "QuickPodsのログフォルダーを開く",
            ["OpenLogs"] = "ログを開く",
            ["CopyDiagnosticsName"] = "QuickPodsの診断情報をクリップボードへコピー",
            ["CopyDiagnostics"] = "診断情報をコピー",
            ["CheckForUpdatesName"] = "QuickPodsのアップデートを今すぐ確認",
            ["CheckForUpdates"] = "アップデートを確認",
            ["OpenLatestReleaseName"] = "最新のQuickPods Releaseページを開く",
            ["OpenLatestRelease"] = "Releaseページを開く",
            ["UpdateNotChecked"] = "このセッションではアップデートを確認していません。",
            ["CheckingForUpdates"] = "最新のQuickPods Releaseを確認しています…",
            ["UpdateUpToDateStatus"] = "新しいReleaseはありません（公開中の最新版: v{0}）。最終確認: {1}",
            ["UpdateAvailableStatus"] = "QuickPods v{0}を利用できます。最終確認: {1}",
            ["UpdateCheckFailedStatus"] = "アップデートを確認できませんでした: {0}",
            ...
            ["ChoiceNotificationAreaLeftDefault"] = "通知領域の左（既定）",
            ["ChoiceTaskbarLeft"] = "タスクバー左側",
            ...
            ["ReleasePageOpenFailed"] = "QuickPodsのReleaseページを開けませんでした: {0}",
            ...
            ["TrayRefresh"] = "デバイス状態を更新",
            ["TrayCheckForUpdates"] = "アップデートを確認...",
            ["TraySettings"] = "QuickPods 設定...",
            ["TrayTaskbarBar"] = "タスクバー操作バーを表示",
            ["TraySoundSettings"] = "サウンド設定",
            ["TrayBluetoothSettings"] = "Bluetooth設定",
            ["TrayExit"] = "終了",
            ["UpdateNotificationTitle"] = "QuickPods アップデート",
            ["UpdateAvailableNotification"] = "QuickPods v{0}を利用できます。クリックして公式Releaseページを開きます。",
            ["UpToDateNotification"] = "QuickPods v{0}は最新です。",
            ["UpdateCheckFailedNotification"] = "最新Releaseを確認できませんでした。QuickPods設定から再試行してください。",
