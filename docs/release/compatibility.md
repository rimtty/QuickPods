...
- Horizontal Windows 11 taskbar with verified free space left of the notification area for the embedded surface
...
The experimental embedded surface supports center- and left-aligned taskbar buttons by selecting the nearest verified gap immediately left of the notification area. Incomplete taskbar identity, notification-area geometry, monitor, DPI, or obstacle evidence hides the surface and keeps notification-area access available.
