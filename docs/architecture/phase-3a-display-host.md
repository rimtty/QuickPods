...
The suite remains intentionally focused: sixteen new test executions were added to the existing Foundation suite rather than porting the Spike's diagnostic test inventory.
